...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/tree/master#an-introduction-to-cryptography)

## Short description

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/tree/master#short-description)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/tree/master#motivation-and-aims)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/tree/master#target-audience)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/tree/master#reading-guidelines)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/tree/master#acknowledgements)
...
The main additional sources that have been helpful in creating the overview in this book are Simon Singh, _The Code Book_, Fourth Estate (London, 1999); Christof Paar and Jan Pelzl, _Understanding Cryptography_, Springer (Heidelberg, 2010) and a course based on the book by Paar called “Introduction to Cryptography” (available at [https://www.youtube.com/channel/UC1usFRN4LCMcfIV7UjHNuQg](https://www.youtube.com/channel/UC1usFRN4LCMcfIV7UjHNuQg)); and Bruce Schneier, Applied Cryptography, 2nd edn, 2015 (Indianapolis, IN: John Wiley & Sons).
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/tree/master#contributions)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#chapter-1-what-is-cryptography)

Let’s start our enquiry into the field of cryptography with one of the more charming and entertaining episodes in its history: that of the Beale ciphers.[1](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#footnote1)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#the-beale-ciphers)
...
You can see the second ciphertext in _Figure 2_ below.[2](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#footnote2) The key to this ciphertext is the United States Declaration of Independence. The decryption procedure comes down to the applying the following two rules:
...
_Figure 1: Beale cipher no. 2_

[![Figure 1: Beale cipher no 2.](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure1-1.png "Figure 1: Beale cipher no. 2")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure1-1.png)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#modern-cryptography)
...
First, historically cryptography has only been concerned with **secrecy** (or confidentiality).[3](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#footnote3) Ciphertexts would be created to ensure that only certain parties could be privy to the information in the plaintexts, as in the case of the Beale ciphers. In order for an encryption scheme to serve this purpose well, decrypting the ciphertext should only be feasible if you have the key.

Modern cryptography is concerned with a wider range of themes than just secrecy. These themes include primarily (1) **message integrity**—that is, assuring that a message has not been changed; (2) **message authenticity**—that is, assuring that a message has really come from a particular sender; and (3) **non-repudiation**—that is, assuring that a sender cannot falsely deny later that she sent a message.[4](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#footnote4)
...
Given these four aspects to modern cryptography, we might characterize modern **cryptography** as the science concerned with the formal development and analysis of cryptographic schemes to secure digital information against adversarial attacks.[6](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#footnote6) Security here should be broadly understood as preventing attacks that damage secrecy, integrity, authentication, and/or non-repudiation in communications.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#open-communications)
...
It would be impossible to prevent potential attackers from physically accessing this network of cables and its supporting infrastructure. In fact, we already know that most of our data is intercepted by various national intelligence agencies at crucial intersections of the Internet.[7](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#footnote7) This includes everything from Facebook messages to website addresses that you visit.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%201%20-%20What%20is%20Cryptography.md#notes)

1. For a good summary of the story, see Simon Singh, _The Code Book_, Fourth Estate (London, 1999), pp. 82-99. A short movie of the story was made by Andrew Allen in 2010. You can find the movie, “The Thomas Beale Cipher,” on its website ([http://www.thomasbealecipher.com/](http://www.thomasbealecipher.com/)).
...
5. See Jonathan Katz and Yehuda Lindell, _Introduction to Modern Cryptography_, CRC Press (Boca Raton, FL: 2015), esp. pp. 16–23, for a good description.
...
7. See, for instance, Olga Khazan, “The creepy, long-standing practice of undersea cable tapping”, _The Atlantic_, July 16, 2013 (available at [https://www.theatlantic.com/international/archive/2013/07/the-creepy-long-standing-practice-of-undersea-cable-tapping/277855/](https://www.theatlantic.com/international/archive/2013/07/the-creepy-long-standing-practice-of-undersea-cable-tapping/277855/)).

# Chapter 2: Mathematical Foundations of Cryptography I

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#chapter-2-mathematical-foundations-of-cryptography-i)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#random-variables)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#graphing-random-variables)
...
_Figure 1: Random variable X_

[![Figure 1: Random variable X.](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure2-1.png "Figure 1: Random variable X")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure2-1.png)

The wide bars in _Figure 1_ obviously do not mean to suggest that the random variable X is actually continuous. Instead, the bars are made wide in order to be more visually appealing (just a line straight up provides a less intuitive visualization).

### Uniform variables

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#uniform-variables)

In the expression “random variable,” the term “random” just means “probabilistic”. In other words, it just means that two or more possible outcomes of the variable occur with certain probabilities. These outcomes, however, do _not necessarily_ have to be equally likely (though the term “random” can indeed have that meaning in other contexts).

A **uniform variable** is a special case of a random variable. It can take on two or more values all with an equal probability. The random variable X depicted in _Figure 1_ is clearly a uniform variable, as both possible outcomes occur with a probability 0.5. There are, however, many random variables that are not instances of uniform variables.
...
A graphical depiction of Y is provided in _Figure 2_.

_Figure 2: Random variable Y_

[![Figure 2: Random variable Y.](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure2-2.png "Figure 2: Random variable Y")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure2-2.png)
...
_Figure 3: Random variable Z_

[![Figure 3: Random variable Z.](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure2-3.png "Figure 3: Random variable Z")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure2-3.png)

### Conditional probability

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#conditional-probability)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#the-modulo-operation)
...
- First determine the closest value _lower than or equal to_ the dividend into which the divisor divides with a remainder of zero. Call that value p.
...
Without brackets, the modulo operation acts on _both sides_ of an expression. Suppose, for instance, the following expression: x = y mod z. If y equals 25 and z equals 4, then all we know is that x mod 4 evaluates to 1. This is consistent with any value for x from the set {….– 7, – 3, 1, 5, 9….}.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#the-shift-cipher)
...
Lets first define it. Suppose a dictionary _D_ that equates all the letters of the English alphabet, in order, with the set of numbers {0,1,2…,25}. Assume a message space **M**. The **shift cipher** is, then, an encryption scheme defined as follows:

- Select uniformly a key k out of the key space **K**, where **K** = {0,1,2,…,25}[1](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#footnote1)
- Encrypt a message m є **M**, as follows:
    - Separate m into its individual letters m0, m1,….mi….,ml
    - Convert each mi to a number according to _D_
    - For each mi, ci = [(mi + k) mod 26]
    - Convert each ci to a letter according to _D_
    - Then combine c0, c1,….,cl to yield the ciphertext c
- Decrypt a ciphertext c as follows: -- Convert each ci to a number according to _D_ -- For each ci, mi = [(ci – k) mod 26] -- Convert each mi to a letter according to _D_ -- Then combine m0, m1,….,ml to yield the original message m
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#the-xor-operation)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#pseudorandomness)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%202%20-%20Mathematical%20Foundations%20of%20Cryptography%20I.md#notes)

1. We can define this statement exactly, using the terminology from the previous section. Let a uniform variable K have **K** as its set of possible outcomes. So Pr [K = 0] = 1/26, Pr [K = 1] = 1/26, and so on. Sample the uniform variable K once to yield a particular key.

2. If interested in a more formal exposition on these matters, you can consult Katz and Lindell’s _Introduction to Modern Cryptography_, esp. chapter 3.

# Chapter 3: Mathematical Foundations of Cryptography II

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#chapter-3-mathematical-foundations-of-cryptography-ii)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#what-is-number-theory)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#groups)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#cyclic-groups)
...
Next, the function φ(N) calculates the number of coprimes up until a number N, and is known as **Euler’s Phi function**.[1](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#footnote1) According to **Euler’s Theorem**, whenever two integers a and N are coprimes, the following holds:
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#fields)
...
If some finite field has a prime number of elements, then it is called a **prime field**. If the number of elements in the finite field is a prime power, then the field is called an **extension field**. In cryptography, we are interested in both prime and extension fields.[2](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#footnote2)
...
[(x3) – (x3 + x + 1)] mod x3 + x + 1 = [x + 1] mod x3 + x + 1 = x + 1
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#abstract-algebra-in-practice)
...
Most importantly, you will see the importance of number theoretic groups and fields in practice through their application in cryptography, particularly public key cryptography. We have already seen in our discussion of fields, for instance, how extension fields are employed in the Rijndael Cipher. We will work out that example in _Chapter 5_.

## Further exploration

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#further-exploration)

For further discussion on abstract algebra, I would recommend the excellent video series on abstract algebra by Socratica.[4](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#footnote4) I would particularly recommend the following videos: “What is abstract algebra?”, “Group definition (expanded)”, “Ring definition (expanded)”, and “Field definition (expanded).” These four videos will give you some additional insight into much of the discussion above. (We did not discuss rings, but a field is just a special type of ring.)

For further discussion on modern number theory, you can consult many advanced discussions on cryptography. I would offer as suggestions Jonathan Katz and Yehuda Lindell’s Introduction to Modern Cryptography or Christof Paar and Jan Pelzl’s Understanding Cryptography for further discussion.[5](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#footnote5)

## Notes

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%203%20-%20Mathematical%20Foundations%20of%20Cryptography%20II.md#notes)

1. The function works as follows. Any integer N can be factored into a product of primes. Suppose that a particular N is factored as follows: p1e1 • p2e2 …. • pmem where all the p’s are prime numbers and all the e’s are integers greater than or equal to 1. Then, φ(N) = Sumi=1…m[piei – piei - 1].
...
3. See [https://www.youtube.com/watch?v=NOMUnMuxDZY&feature=youtu.be](https://www.youtube.com/watch?v=NOMUnMuxDZY&feature=youtu.be).

4. Socratica, Abstract Algebra, available at: [https://www.socratica.com/subject/abstract-algebra](https://www.socratica.com/subject/abstract-algebra).

5. Katz and Lindell, _Introduction to Modern Cryptography_, 2nd edn, 2015 (CRC Press: Boca Raton, FL). Paar and Pelzl, _Understanding Cryptography_, 2010 (Springer-Verlag: Berlin).

# Chapter 4: Symmetric Cryptography

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#chapter-4-symmetric-cryptography)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#alice-and-bob)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#symmetric-encryption-schemes)
...
You can see a depiction of situation (1) in _Figure 1_ below. Bob wants to send a message M to Alice across a distance, but does not want others to be able to read that message.
...
You can see a depiction of situation (2) in _Figure 2_ below. Bob wants to prevent others from viewing certain information. A typical situation might be that Bob is an employee storing sensitive data on his computer, which neither outsiders nor his colleagues are supposed to read.
...
_Figure 1: Secrecy across space_

[![Figure 1: Secrecy across space](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-1.png "Figure 1: Secrecy across space")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-1.png)

_Figure 2: Secrecy across time_

[![Figure 2: Secrecy across time](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-2.png "Figure 2: Secrecy across time")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-2.png)

## An example: The shift cipher

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#an-example-the-shift-cipher)
...
Suppose a dictionary _D_ that equates all the letters of the English alphabet, in order, with the set of numbers {0,1,2…,25}. Assume a set of possible messages **M**. The shift cipher is, then, an encryption scheme defined as follows:
...
- Decrypt a ciphertext c as follows:
    - Convert each ci to a number according to _D_
    - For each ci, mi = [(ci – k) mod 26]
    - Convert each mi to a letter according to _D_
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#brute-force-attacks-and-kerckhoffs-principle)

The shift cipher is a very insecure symmetric encryption scheme, at least in the modern world.[1](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#footnote1) An attacker could just attempt decryption of any ciphertext with all 26 possible keys to see which result makes sense. This type of attack, where the attacker is just cycling through keys to see what works, is known as a **brute force attack** or **exhaustive key search**.
...
Kerckhoffs’ principle is central to modern cryptography for four reasons.[2](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#footnote2) First, there are only a limited number of cryptographic schemes for particular types of applications. For instance, most modern symmetric encryption applications use the Rijndael cipher. So your secrecy regarding a scheme’s design is just very limited. There is, however, much more flexibility in keeping some private key for the Rijndael cipher secret.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#stream-ciphers)
...
A typical XOR stream cipher is depicted in _Figure 3_. You first take a private key K and use it to generate a keystream. The keystream is, then, combined with the plaintext via an XOR operation to produce the ciphertext. Any agent that receives the ciphertext can easily decrypt it if they have the key K. All she needs to do is create a keystream as long as the ciphertext according to the specified procedure of the scheme and XOR it with the ciphertext.

_Figure 3: An XOR stream cipher_

[![Figure 3: An XOR stream cipher](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-3.png "Figure 3: An XOR stream cipher")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-3.png)
...
While the Shift cipher and Vigenere ciphers are very insecure in the modern age, the one-time pad is very secure if used correctly. Probably the most famous application of the one-time pad was, at least until the 1980s, for the **Washington-Moscow hotline**.[4](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#footnote4)
...
A pseudorandom keystream appears _as if_ it was chosen completely randomly from the set of all strings with the same length. Hence, encryption with a pseudorandom keystream appears as if it had been done with a one-time pad. But that is, of course, not the case.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#block-ciphers)
...
A depiction of how a block cipher works can be seen in _Figure 4_ below. A message M of length L and a key K serve as inputs to the Block cipher. It outputs a message M’ of length L. The key does not necessarily need to be the same length as M and M’ for most block ciphers.

_Figure 4: A block cipher_

[![Figure 4: A block cipher](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-4.png "Figure 4: A block cipher")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-4.png)
...
_Figure 5: A block cipher with ECB mode_

[![Figure 5: A block cipher with ECB mode](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-5.png "Figure 5: A block cipher with ECB mode")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-5.png)
...
Instead, any encryption scheme constructed from a block cipher should be **probabilistic**: that is, the encryption of any message M, or any specific chunk of M, should generally yield a different outcome each time.[5](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#footnote5)
...
_Figure 6: A block cipher with CBC mode_

[![Figure 6: A block cipher with CBC mode](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-6.png "Figure 6: A block cipher with CBC mode")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-6.png)
...
Finally, lets turn our attention to **output feedback mode** (**OFB mode**). You can see a depiction of this mode in _Figure 7_.

_Figure 7: A block cipher with OFB mode_

[![Figure 7: A block cipher with OFB mode](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-7.png "Figure 7: A block cipher with OFB mode")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-7.png)
...
The Rijndael cipher can be used with different specifications for key lengths and block sizes, as well as in different modes of operation. The committee for the NIST competition adopted a constricted version of the Rijndael cipher—namely one which requires 128-bit block sizes and key lengths of either 128 bits, 192 bits, or 256 bits—as part of the **advanced encryption standard** (**AES**). This is really the main standard for symmetric encryption applications. It is so secure that even the NSA is apparently willing to use it with 256-bit keys for top secret documents.[6](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#footnote6)

The AES block cipher will be explained in detail in _Chapter 5_.

## Clearing up the confusion

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#clearing-up-the-confusion)

The confusion about the distinction between block ciphers and stream ciphers arises because sometimes people will understand the term block cipher as referring specifically to a _block cipher with a block mode of encryption_.
...
From this discussion, you should now understand _Figure 8_. It provides an overview on symmetric encryption schemes. We use three kinds of encryption schemes: primitive stream ciphers, block cipher stream ciphers, and block ciphers in a block mode (also called “block ciphers” in the diagram).

_Figure 8: Overview of symmetric encryption schemes_

[![Figure 8: Overview of symmetric encryption schemes](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-8.png "Figure 8: Overview of symmetric encryption schemes")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-8.png)

## Message authentication codes

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#message-authentication-codes)
...
The process is depicted in _Figure 9_. To use a MAC, they would first generate a private key K that is shared between the two of them. Bob creates a tag T for the message using the private key K. He, then, sends the message as well as the message tag to Alice. She can, then, verify that Bob indeed made the tag, by running the private key, the message, and the tag through a verification algorithm.

_Figure 9: Overview of symmetric encryption schemes_

[![Figure 9: Overview of symmetric encryption schemes](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-9.png "Figure 9: Overview of symmetric encryption schemes")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-9.png)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#authenticated-encryption)
...
The aforementioned principle applies more generally: _you should always use distinct keys when combining basic cryptographic schemes_.

An authenticated encryption scheme is depicted in _Figure 10_. Bob first creates a ciphertext C from the message M using a randomly selected key KC. He, then, creates a message tag T by running the ciphertext and a different randomly selected key KT through the tag generation algorithm. Both the ciphtertext and the message tag are sent to Alice.
...
_Figure 10: An authenticated encryption scheme_

[![Figure 10: An authenticated encryption scheme](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-10.png "Figure 10: An authenticated encryption scheme")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-10.png)
...
[![Figure 11: HMAC](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-11.png "Figure 11: HMAC")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-11.png)

## Secure communication sessions

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#secure-communication-sessions)
...
To illustrate how secure communication sessions work, suppose again Alice and Bob. They send a total of four messages back and forth. You can see how an authenticated encryption scheme with identifiers and sequence numbers would work below in _Figure 11_.
...
_Figure 12: A secure communication session_

[![Figure 12: A secure communication session](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure4-12.png "Figure 12: A secure communication sessesion")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure4-12.png)

## Notes

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%204%20-%20Symmetric%20Cryptography.md#notes)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#chapter-5-rc4-and-aes)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#the-rc4-stream-cipher)

In order to have a sense of how modern pseudorandom stream ciphers work, I will focus on the RC4 stream cipher. It is a pseudorandom stream cipher that was used in the WEP and WAP wireless access point security protocols as well as in TLS. As RC4 has many proven weaknesses, it has fallen into disfavor. In fact, the Internet Engineering Task Force now forbids the use of RC4 suites by client and server applications in all instances of TLS.[3](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#footnote3) Nevertheless, it works well as an example to illustrate how a primitive stream cipher works.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#step-1)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#step-2)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#step-3)
...
The transformation of array S is captured by _Table 1_.
...
_Table 1: Key scheduling table_

[![Table 1: Key scheduling table](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Table5-1.png "Table 1: Key scheduling table")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Table5-1.png)

### Step 4

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#step-4)
...
You can follow the calculations in _Table 2_.
...
_Table 2: Keystream generation_

[![Table 2: Keystream generation](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Table5-2.png "Table 2: Keystream generation")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Table5-2.png)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#aes-with-a-128-bit-key)
...
_Figure 1: AES-ECB with a 128-bit key_

[![Figure 1: AES-ECB with a 128-bit key](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure5-1.png "Figure 1: AES-ECB with a 128-bit key")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure5-1.png)
...
_Figure 2: The manipulation of M1 with the Rijndael cipher_

[![Figure 2: AES-ECB with a 128-bit key](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure5-2.png "Figure 2: AES-ECB with a 128-bit key")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure5-2.png)

### Round 0

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#round-0)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#round-1)

In round 1, the array S0 is first combined with the round key K1 using an XOR operation. This produces a new state of S.

Second, the byte substitution operation is performed on the current state of S. It works by taking each byte of the 16-byte S array and subtituting it with a byte of an array called **Rijndael’s S-box**. Each byte has a unique transformation, and a new state of S is produced as a result. Rijndael's S-box is displayed in _Figure 3_.

_Figure 3: Rijndael's S-Box_

[![Figure 3: Rijndael's S-Box](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure5-3.png "Figure 3: Rijndael's S-Box")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure5-3.png)
...
Once the matrix of S has been constructed, the four rows are shifted. The first row stays the same. The second row moves one over to the left. The third moves two over to the left. The fourth moves three over to the left. An example of the process is provided in _Figure 4_. The original state of S is shown on the top, the resultant state after the shift rows operation is shown below it.

_Figure 4: Shift rows operation_

[![Figure 4: Shift rows operation](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure5-4.png "Figure 4: Shift rows operation")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure5-4.png)

In the fourth step, Galois fields make an appearance again. To start, each column of the S matrix is multiplied by the column of the 4 x 4 matrix seen in _Figure 5_. But instead of being regular matrix multiplication, it is vector multiplication modulo an irreducible polynomial, x8 + x4 + x3 + x + 1. The resulting vector coefficients represent the individual bits of a byte.

_Figure 5: Mix columns matrix_

[![Figure 5: Mix columns matrix](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure5-5.png "Figure 5: Mix columns matrix")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure5-5.png)

Multiplication of the first column of the S matrix with the 4 x 4 matrix above yields the result in _Figure 6_.

_Figure 6: Multiplication of the first column_

[![Figure 6: Multiplication of the first column](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure5-6.png "Figure 6: Multiplication of the first column")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure5-6.png)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#rounds-2-through-10)

Rounds 2 through 9 are just a repetition of round 1, _mutatis mutandis_. The final round looks very similar to the previous rounds, except that the mix columns step is eliminated. That is, round 10 is executed as follows:
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%205%20-%20RC4%20and%20AES.md#the-operations-of-the-rijndael-cipher)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#chapter-6-asymmetric-cryptography)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#the-key-distribution-and-management-problem)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#new-directions-in-cryptography)
...
> The development of computer controlled communication networks promises effortless and inexpensive contact between people or computers on opposite sides of the world, replacing most mail and many excursions with telecommunications. For many applications these contacts must be made secure against both eavesdropping and the injection of illegitimate messages. At present, however, the solution of security problems lags well behind other areas of communications technology. _Contemporary cryptography is unable to meet the requirements, in that its use would impose such severe inconveniences on the system users, as to eliminate many of the benefits of teleprocessing._[1](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#footnote1)
...
The first solution they offered was a remote _key-exchange protocol_, that is, a set of rules for the exchange of one or more symmetric keys over an insecure communication channel. This protocol is now known as _Diffie-Helmann key exchange_ or _Diffie-Helmann-Merkle key exchange_.[2](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#footnote2)
...
A practical implementation of an asymmetric scheme was, however, found a year later by three different academic cryptographers and mathematicians: Ronald Rivest, Adi Shamir, and Leonard Adleman.[3](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#footnote3) The cryptosystem they introduced became known as the **RSA cryptosystem** (after their last names).
...
According to their own accounts and that of GCHQ, it was James Ellis who first devised the concept of public key cryptography in 1969. Supposedly, Clifford Cocks then discovered the RSA cryptographic system in 1973, and Malcolm Williamson the concept of Diffie Helmann key exchange in 1974.[4](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#footnote4) Their discoveries were, however, purportedly not revealed until 1997, given the secret nature of the work done at GCHQ.

## Asymmetric encryption and authentication

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#asymmetric-encryption-and-authentication)

An overview of asymmetric encryption with the help of Bob and Alice is provided in _Figure 1_.
...
_Figure 1: Asymmetric encryption_

[![Figure 1: Asymmetric encryption](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure6-1.png "Figure 1: Asymmetric encryption")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure6-1.png)
...
For authentication in the asymmetric setting, we use **digital signatures**. These, thus, have the same function as message authentication codes in the symmetric setting. An overview of digital signatures is provided in _Figure 2_.
...
_Figure 2: Asymmetric authentication_

[![Figure 2: Asymmetric authentication](https://github.com/JWBurgers/An_Introduction_to_Cryptography/raw/master/Images/Figure6-2.png "Figure 2: Asymmetric authentication")](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Images/Figure6-2.png)
...
Importantly, in many applications asymmetric cryptography is not used throughout the entire communication process. Instead, it will typically only be used to _exchange symmetric keys_ between the parties by which they will actually communicate.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#hash-functions)
...
All the outputs are exactly 256 bits written out in hexadecimal format (each hex digit can be represented by four binary digits). So even if you had inserted Tolkien’s _The Lord of the Rings_ book into the SHA-256 function, the output would still be 256 bits.

Hash functions such as SHA-256 are employed to various ends in cryptography. Which properties are required from a hash function really depends on the context of a particular application. There are two main properties generally desired of hash functions in cryptography:[6](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#footnote6)
...
3. Next, you need to download the executable for Bitcoin Core from their [website](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/www.bitcoincore.org). There will be packages available for Linux, Windows, and MAC operating systems.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%206%20-%20Asymmetric%20Cryptography.md#notes)
...
5. Any schemes attempting to achieve non-repudiation, the other theme we discussed in _Chapter 1_, will at its basis need to involve digital signatures.

6. The “hiding” terminology is not common language, but taken specifically from Arvind Narayanan, Joseph Bonneau, Edward Felten, Andrew Miller, and Steven Goldfeder, _Bitcoin and Cryptocurrency Technologies_, Princeton University Press (Princeton, 2016), Chapter 1.

# The RSA cryptosystem

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#the-rsa-cryptosystem)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#the-factoring-problem)

Whenever you multiply two numbers, say a and b, we refer to the numbers a and b as **factors**, and the result as the **product**. Attempting to write a number N into the multiplication of two or more factors is called **factorization** or **factoring**.[1](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#footnote1) You can call any problem that requires this a **factorization problem**.
...
_Theorem 1_. Every integer N which is greater than 1 is either a prime number, or can be expressed as a product of prime factors.
...
For concreteness, let’s say that p and q are both 1024-bit primes, and that they indeed require at least 1024 bits in order to be represented (so the first bit must be 1). So, for example, 37 could not be one of the prime numbers. You can certainly represent 37 with 1024 bits. But clearly _you do not need_ this many bits to represent it. You can represent 37 by any string that has 6 bits or more. (In 6 bits, 37 would be represented as 100101).
...
To start, suppose that the computer attempts to solve the problem by cycling through 1024 bit numbers, testing in each case whether they are prime and if they are factors of N. The set of prime numbers to be tested is then approximately 1.265 • 10305.[2](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#footnote2)
...
Now in practice a computer can do better than the rough procedure just described. There exist several algorithms that the computer can apply to come to a factorization more quickly. The point, however, is that even using these more efficient algorithms, the computer’s task is still computationally infeasible.[3](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#footnote3)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#number-theoretic-results)
...
Some of the material in the three subsections has already been introduced in _Chapter 3_. But I will here restate that material for convenience.

### The order of N

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#the-order-of-n)
...
_Theorem 2_. Let N equal p1e_1 • p2e_2 • … • pie_i • … • pne_n, where the set {pi} consists of all the distinct prime factors of N and each e_i indicates how many times the prime factor pi occurs for N. Then, φ(N) = p1e_1 - 1 • (p1 - 1) • p2e_2 - 1 • (p2 - 1) • … • pne_n - 1 • (pn - 1).

_Theorem 2_ shows that once you have broken down any non-prime N into its distinct prime factors, it is easy to calculate the order of N.
...
Suppose next that N is a product of two primes, p and q. _Theorem 2_ above, then, states that the order of N is as follows: p1 – 1 (p – 1) x q1 – 1 (q – 1) = (p – 1) x (q – 1). This is a key result for the RSA problem particularly, and is stated in _Proposition 2_ below.

_Proposition 2_. If N is the product of two primes, p and q, the order of N is the product (p – 1) x (q – 1).
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#invertibility-modulo-n)
...
_Proposition 3_. If the integer a is invertible modulo N, it must be the case that exactly one positive inverse of a is less than N. (So, this unique inverse of a must come from the set {1,…,N – 1}).
...
_Proposition 4_. An inverse exists of an integer a given reduction modulo N, and specifically a unique positive inverse less than N, if and only if the greatest common divisor between a and N is 1 (that is, if they are coprimes).
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#eulers-theorem)
...
_Theorem 3_. Suppose two integers a and N are coprimes. Then, aφ(N) mod N = 1 mod N.
...
Next, using Euler’s Phi function, _Theorem 2_, you can derive _Proposition 5_ below.

_Proposition 5_. φ(a • b) = φ(a) • φ(b) for any positive integers a and b.

We will not show why this is the case. But merely note that you have already seen evidence of this proposition by the fact that φ(p • q) = φ(p) • φ(q) = (p – 1) • (q – 1) when p and q are primes, as stated in _Proposition 2_.

Euler’s theorem in conjunction with _Proposition 5_ has important implications. See what happens, for instance, in the expressions below, where a and N are coprimes.
...
Hence, the combination of Euler’s theorem and _Proposition 5_ allow us to simply calculate a number of expressions. In general, we can summarize the insight as in _Proposition 6_.

_Proposition 6_. ax mod N = ax mod φ(N)
...
Suppose that we now select an integer e from the set **CR**. We know from _Proposition 3_ that this integer e only has one unique positive inverse less than R. That is, e has one unique inverse from the set **CR**. Lets call this inverse d. Given the definition of an inverse, this means that e • d = 1 mod R.

We can use this result to make a statement about our original integer N. This is summarized in _Proposition 7_.

_Proposition 7_. Suppose that e • d mod φ(N) = 1 mod φ(N). Then for any element a of the set **CN** it must be the case that ae • d mod φ(N) = a1 mod φ(N) = a mod N.

We know have all the number theoretic results needed to state the RSA problem clearly.

## The RSA cryptosystem

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#the-rsa-cryptosystem-1)
...
Importantly, given _Proposition 4_, we know that no other integer between 1 and 360 for d will produce the result that 103 • d = 1 mod 360. Additionally, the proposition implies that selecting a different value for e, will yield a different unique value for d.
...
Nevertheless, with adding a bit of clever complexity, the RSA problem can be used to create a secure public key encryption scheme as well as a secure digital signature scheme. We will not enter into the details of such constructions here.[4](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#footnote4) Importantly, however, this additional complexity does not change the fundamental underlying RSA problem on which these schemes are based.

## Notes

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Chapter%207%20-%20The%20RSA%20cryptosystem.md#notes)

1. Factorization can also be important for working with other types of mathematical objects than numbers. For instance, it can be useful to factor polynomial expressions such x2 – 2x + 1. In our discussion, we will only focus on the factorization of numbers, specifically integers.

2. According to the prime number theorem, the number of primes less than or equal to N is approximately N/ln⁡(N). This means that you can approximate the number of primes of length 1024 bits by 21024/ln⁡(21024) - 21023/ln⁡(21023) which equals approximately 1.265 x 10305.
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/License.md#license)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Notation.md#notation)

## Key terms

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Notation.md#key-terms)
...
[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Notation.md#emphasized-words-and-phrases)

Words and phrases are emphasized via italics. For instance, the phrase "Remember your password" would look as follows: _Remember your password_.

## Formal notation

[](https://github.com/JWBurgers/An_Introduction_to_Cryptography/blob/master/Notation.md#formal-notation)
